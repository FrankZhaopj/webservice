 ...
 * 2017-09-09T23:24:44.734+08:00
 * Generated source version: 3.1.12
 * 
 */
@WebServiceClient(name = "MyWebServiceService", 
                  wsdlLocation = "http://localhost:8080/spring-cxf-ws-server/webservice/MyWs?wsdl",
...
public class MyWebServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/spring-cxf-ws-server/webservice/MyWs?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MyWebServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/spring-cxf-ws-server/webservice/MyWs?wsdl");
        }
        WSDL_LOCATION = url;
    }
