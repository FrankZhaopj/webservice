 ...
 * 2017-09-09T09:58:42.172+08:00
 * Generated source version: 3.1.12
 * 
 */
@WebServiceClient(name = "HelloWorldService", 
                  wsdlLocation = "http://192.168.31.42/sayHello?wsdl",
                  targetNamespace = "http://webservice.zhaopj.com/") 
public class HelloWorldService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://webservice.zhaopj.com/", "HelloWorldService");
    public final static QName HelloWorldPort = new QName("http://webservice.zhaopj.com/", "HelloWorldPort");
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.31.42/sayHello?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.31.42/sayHello?wsdl");
        }
        WSDL_LOCATION = url;
    }
