...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("http://webservice.zhaopj.com/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://webservice.zhaopj.com/", "sayResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.zhaopj.com/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.zhaopj.com/", name = "sayResponse")
